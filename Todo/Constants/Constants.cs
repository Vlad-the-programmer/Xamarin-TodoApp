namespace Todo.Constants
{
    public class Constants
    {
        ...
        public const string UsersRegisterEndpoints = UsersEndpoints + "/register";
        public const string TagsEndpoint = "tags";
        public const string TodosSearchEndpoint = "todos/search";
